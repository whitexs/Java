...
public class TestPerson3Servlet extends HttpServlet {
    ...
    public TestPerson3Servlet() { super(); }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(color){
		case "빨강" : recommend = "빨간 사과"; 
					 break;
		case "갈색" : recommend = "갈색 사과 나무";
					 break;
		case "파랑" : recommend = "파란 파워에이드";
					 break;
		case "노랑" : recommend = "노란 병아리";
				 	 break;
		}
		...
		out.printf("<h3>당신에게 추천하는 상품은 %s 입니다!!</h3>", recommend);
